...
#define GOOGLE_API_KEY "API_KEY_HERE"
...
// ---- WebSocket server ----
#ifndef WS_HOST
#define WS_HOST "HOST_DOMAIN_HERE" // hostname only, no scheme
#endif
#ifndef WS_PORT
#define WS_PORT 443
#endif
...
void onWsEvent(WStype_t type, uint8_t *payload, size_t length)
{
  ...
  case WStype_DISCONNECTED:
    ...
    if (callActive)
    {
      ...
      callActive = false;
      wsPendingConnect = false;
      ws.disconnect();                   // stop the reconnect timer
